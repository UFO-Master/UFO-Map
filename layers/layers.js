...
lyr__1.set('fieldLabels', {'Название': 'inline label - visible with data', 'Широта': 'no label', 'Долгота': 'no label', 'Фото': 'inline label - visible with data', 'Описание': 'inline label - visible with data', });
