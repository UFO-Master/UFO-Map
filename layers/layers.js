...
lyr__1.set('fieldLabels', {'Название': 'hidden field', 'Широта': 'inline label - visible with data', 'Долгота': 'inline label - visible with data', 'Фото': 'hidden field', 'Описание': 'inline label - always visible', });
